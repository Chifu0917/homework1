...
```{r ans13}
mean <- as.integer(fromEcon)
mean
meanEcon <- sum(mean*grade/sumEcon)
meanEcon
```
...
gradepass <- grade >= 60
gradepass
as.integer(gradepass)
earnedCredit1 <- as.integer(gradepass)*credit
class(earnedCredit1)
...
studentID
studentID == "046S6f645"
find1 <- studentID == "046S6f645" & schoolYear == 100
find2 <- as.integer(find1)
credit100ChosenStudent <- sum(find2*credit)
...
```{r ans33}
find3 <- studentID == "046S6f645" & schoolYear == 100 & gradepass
find3
find4 <- as.integer(find3)
credit100ChosenStudent <- sum(find4*credit)
credit100ChosenStudent
```
...
```{r ans34}
scan <- studentID == "046S6f645" & schoolYear == 100 & credit > 0
scan1 <- as.integer(scan)
creditamount <- sum(credit & scan)
creditamount
gpa100ChosenStudent <- sum(scan1*credit*grade/creditamount)
gpa100ChosenStudent
```
